...
module.exports = class Util {
  ...
  async updateVanity(guild, code) {
    try {
      ...
      let body = '{"code":"POGYCLIENT"}';
      body = body.replace("POGYCLIENT", code);
      let options = {
        method: "PATCH",
        headers: {
          Accept: "*/*",
  ...
  async errorDelete(message, description) {
    ...
    const embed = new EmbedBuilder()
      .setTitle("Error")
      .setDescription(this.client.config.Client.emoji.cross + " " + safeDescription)
  ...
  async doDeletesend(message, description) {
    ...
    const embed = new EmbedBuilder()
      .setTitle("Success")
      .setDescription(this.client.config.Client.emoji.tick + " " + safeDescription)
  ...
  async errorButtonEmbed(message, description, perm) {
    const safeDescription =
      typeof description === "string" && description.trim().length
        ? description.trim()
        : "I do not have the required permissions to complete that action.";
    const embed = new EmbedBuilder()
      .setTitle("Error")
