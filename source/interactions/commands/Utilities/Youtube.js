    ...
    async run({ message, args }) {
        ...
        collector.on("collect", async (button) => {
            if (button.customId === "enable") {
                ...
                let nuinuicollector = nuinuimsg.channel.createMessageCollector({
                ...
                let nuinuicollector2 = nuinuimsg2.channel.createMessageCollector({
                    filter: (m) => m.author.id === message.author.id,
                    time: 30000,
                });
                await new Promise((resolve) => {
                ...
                let nuinuicollector3 = nuinuimsg3.createMessageComponentCollector({
                    filter: (button) => button.user.id === message.author.id,
                    time: 30000,
                });
